	...
	<div class="xuiBaseMain">
		<el-form :model="compStore.currentComp" label-width="80px">
			<el-form-item label="宽度">
				<el-input-number class="formItemVal" v-model="formData.width" :min="1" controls-position="right" />
			</el-form-item>
			<el-form-item label="高度">
				<el-input-number class="formItemVal" v-model="formData.height" :min="1" controls-position="right" />
			</el-form-item>
			<el-form-item label="位置">
				<div class="formTwoItem">
					<el-input-number class="formItemVal" v-model="formData.left" :min="1" controls-position="right" />
					<el-input-number class="formItemVal" v-model="formData.top" :min="1" controls-position="right" />
				</div>
			</el-form-item>
		</el-form>
	</div>
